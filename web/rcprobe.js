...
(function (root, factory) {
  ...
  var G20_HINT = [
    ...
    { ch: 7, label: 'L1 力控/起步/停步' },
    { ch: 8, label: 'L2 起立/趴下/卸力' },
    { ch: 9, label: 'R1：无对讲绑定' },
    { ch: 10, label: 'R2：无键值' },
    { ch: 11, label: '左旋钮：对讲开关+音量' },
    { ch: 12, label: '右旋钮：听球开关+音量' },
    { ch: 13, label: '左小左右：双光=球机水平 / 点云=移中心 / 狗身=不控 / 水炮=炮台水平' },
    { ch: 14, label: '左小上下：双光=球机俯仰 / 点云=移中心 / 狗身=不控 / 水炮=炮台俯仰' },
    { ch: 15, label: '右小左右：双光=切画中画（右下一档 / 左上一档）；狗身不切' },
    { ch: 16, label: '右小前后：双光=变焦 / 点云=缩放 / 狗身=不控 / 水炮=雾状·柱状' },
  ];
